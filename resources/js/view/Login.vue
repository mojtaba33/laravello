        ...
        <div class="sm:w-96 w-72 sm:mt-14 mt-5 text-center">
            ...
            <div class="border-gray-200 border-2 rounded-sm py-8 px-4 mt-5">
                ...
                <div class="mt-8 w-full">
                    <button type="submit" 
                        class="py-1 px-3 text-white font-bold text-sm outline-none focus:outline-none rounded-sm bg-indigo-600 hover:bg-indigo-500 transition-colors duration-300 w-5/6 sm:w-3/4"
                        placeholder="Enter password">Login</button>
                </div>
                <div class="mt-8 w-full">
                    <router-link :to={} class="text-blue-700 hover:text-blue-900 hover:underline text-sm">Sign up for an account</router-link>
                </div>
            </div>
        </div>
    </div>
