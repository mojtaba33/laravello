    ...
    <div class="list">
        ...
        <div v-else class="bg-gray-200 p-2 rounded-sm shadow-md mr-3 ">
            ...
            <div class="flex justify-between items-center w-full ">
                ...
                <span @click="deleteList" class="text-gray-400 font-bold text-md hover:text-gray-500 p-1 cursor-pointer">
            ...
            <div v-if="!showCardEditor && canCreateCard" @click="showCardEditor = true;" class="w-auto p-1 flex justify-start items-center mt-2 rounded-sm bg-transparent text-gray-600 text-left text-sm hover:text-gray-900 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4">
