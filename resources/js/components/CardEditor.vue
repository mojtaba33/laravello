<template>
    <div>
        <textarea ref="editor"
            ...
            ></textarea>
        <button @click.prevent="save" class="bg-indigo-800 hover:bg-indigo-700 text-white py-1 px-2 mt-1 rounded-sm border-none outline-none focus:outline-none">Add Card</button>
